...
_QWEN4_EXP_TRAINING_ARGS = [
    # The ViT eager path shares the patched QSA eager_attention_forward, whose
    # tilelang branch fails closed for non-QSA callers; keep the plain
    # attention backend on sdpa like configs/text/qwen4exp.yaml.
...
def test_qwen4_exp_two_device_training_smoke(tmp_path):
    """Exercise toy Qwen4-Exp VLM SFT with PLE=2, EP=2, and SP=2."""
