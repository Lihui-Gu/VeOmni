...
class OpsImplementationConfig:
    ...
    qsa_attention_implementation: str = "eager"
...
| `qsa_attention_implementation` | `eager` | Qwen4-Exp only. The eager PyTorch implementation expands compact global token indices to an `[S,S]` mask and runs dense quadratic attention. |
